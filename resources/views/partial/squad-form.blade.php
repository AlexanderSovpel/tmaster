<div class="well">
    ...
    <div class="form-group row">
        ...
        <input type="date" id="squad-date-{{$index}}" name="squad_date[]" class="form-control squad-date col-md-4 required"
    ...
    <div class="form-group row">
        ...
        <input type="number" id="squad-max-players-{{$index}}" name="squad_max_players[]"
               class="form-control squad-max-players col-md-4 required" value="8" min="4"
               max="50" required>
    </div>
</div>
